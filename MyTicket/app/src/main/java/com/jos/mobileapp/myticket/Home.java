...
public class Home extends AppCompatActivity {
    LinearLayout btn_ticket_pisa , btn_ticket_monas,btn_ticket_pagoda,btn_ticket_sphinx,btn_ticket_torri,
            btn_ticket_candi ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot dataSnapshot) {
                nama_lengkap.setText(dataSnapshot.child("nama lengkap").getValue().toString());
                bio.setText(dataSnapshot.child("bio").getValue().toString());
                user_balance.setText("US$"+dataSnapshot.child("user_balance").getValue().toString());
                Picasso.with(Home.this).load(dataSnapshot.child("url_photo_profile")
        ...
        btn_to_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotoeditprofile = new Intent(Home.this,MyProfile.class);
